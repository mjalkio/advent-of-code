...
def test_is_valid_password_part_1(
    character, min_usages, max_usages, password, expected
):
    assert (
        is_valid_password_part_1(character, min_usages, max_usages, password)
        == expected
    )
...
def test_is_valid_password_part_2(
    character, position_1, position_2, password, expected
):
    assert (
        is_valid_password_part_2(character, position_1, position_2, password)
        == expected
    )

...
def get_navigation_destination_with_waypoint(
    ...
    instructions = [
        (line[0], int(line[1:])) for line in puzzle_input.split("\n") if line != ""
    ]
...
def get_manhattan_distance_after_navigation(
    ...
    if use_waypoint:
        ending_x, ending_y = get_navigation_destination_with_waypoint(
...
if __name__ == "__main__":
    ...
    print(
        f"Part 2: {get_manhattan_distance_after_navigation(puzzle_input, use_waypoint=True)}"
    )
